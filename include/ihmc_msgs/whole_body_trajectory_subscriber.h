...
#ifndef IHMC_MSG_WHOLE_BODY_TRAJECTORY_SUBSCRIBER_H_
#define IHMC_MSG_WHOLE_BODY_TRAJECTORY_SUBSCRIBER_H_
 ...
 public:
  ...
  get_trajectory() {
    ...
    for (std::size_t i = 0; i < N; ++i) {
      xs_[i].resize(nx_);
      us_[i].resize(nu_);
      ihmc_msgs::fromMsg(model_, data_, msg_.trajectory[i], ts_[i], xs_[i].head(model_.nq),
...
#endif  // IHMC_MSG_WHOLE_BODY_TRAJECTORY_SUBSCRIBER_H_
