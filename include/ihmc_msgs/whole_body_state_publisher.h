...
#ifndef IHMC_MSG_WHOLE_BODY_STATE_PUBLISHER_H_
#define IHMC_MSG_WHOLE_BODY_STATE_PUBLISHER_H_
...
class WholeBodyStateRosPublisher {
 public:
   ...
   */
  WholeBodyStateRosPublisher(pinocchio::Model &model, const std::string &topic = "/ihmc/whole_body_state",
  ...
  void publish(const double t, const Eigen::Ref<const Eigen::VectorXd> &q, const Eigen::Ref<const Eigen::VectorXd> &v,
    ...
    if (pub_.trylock()) {
      ...
      ihmc_msgs::toMsg(model_, data_, pub_.msg_, t, q, v, a_, tau, p, pd, f, s);
...
#endif  // IHMC_MSG_WHOLE_BODY_STATE_PUBLISHER_H_
